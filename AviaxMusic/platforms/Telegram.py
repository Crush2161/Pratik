...
# ये ID उस ग्रुप या चैनल की है जहां आप downloaded फाइल को सेव करना चाहते हैं
TARGET_CHAT_ID = -1002560180379  # इसे अपनी चैनल/ग्रुप ID से बदलें
    ...
    async def get_filename(self, file, audio: Union[bool, str] = None):
        try:
            ...
            if file_name is None:
                file_name = "ᴠᴇʟᴇɢʀᴀᴍ ᴀᴜᴅɪᴏ" if audio else "ᴠᴇʟᴇɢʀᴀᴍ ᴡɪᴅᴇᴏ"
        except:
            file_name = "ᴠᴇʟᴇɢʀᴀᴍ ᴀᴜᴅɪᴏ" if audio else "ᴠᴇʟᴇɢʀᴀᴍ ᴡɪᴅᴇᴏ"
        return file_name
    ...
    async def download(self, _, message, mystic, fname):
        ...
        async def down_load():
            ...
            try:
                ...
                # ✅ डाउनलोड के बाद फाइल को अपने ग्रुप/चैनल में भेजें
